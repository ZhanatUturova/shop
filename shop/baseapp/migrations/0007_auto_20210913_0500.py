...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('baseapp', '0006_auto_20210911_0309'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_orders', to='baseapp.customer', verbose_name='Покупатель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customer', to='baseapp.Order', verbose_name='Заказы покупателя'),
        ),
    ]
